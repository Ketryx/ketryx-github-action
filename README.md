...
| `request-timeout-seconds`   | Timeout in seconds for each request to the Ketryx API (default: `2100`). The generous default gives large uploads (such as SBOMs) time to be processed; lower it to fail faster, or reach out to Ketryx support         | No       | `600`                                                                                                                                                                                                                   |
